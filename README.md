...
**W5（9/14–9/18）** — STEP 2 知識整理第一週。**不教新內容**，把 W1–W4 學過的七大評鑑主題
整理成「統一筆記範本」（核心定義／關鍵詞／常見考點／易混淆比較表），一天一主題。

| 頁面 | 主題 | 整理範圍 | 題數 |
|---|---|---|---|
| `w5-index.html` | 第五週總覽、七大主題知識地圖、跨主題易混淆總表 | — | — |
| `day21.html` | 科目一 3.1 人工智慧概念 | 指引 p.3-1～3-7、3-19～3-23（整理自 W1） | 6 |
| `day22.html` | 科目一 3.2 資料處理與分析概念（含 3 處勘誤） | 指引 p.3-4～3-12、3-24～3-32（整理自 W1） | 6 |
| `day23.html` | 科目一 3.3 機器學習概念 | 指引 p.3-33～3-47（整理自 W3） | 6 |
| `day24.html` | 科目一 3.4 鑑別式／生成式AI ＋ 科目二 3.1、3.2 | 指引 科一 p.3-48～3-49、科二 p.3-1～3-30（整理自 W4 Day 5、W2） | 6 |
| `day25.html` | 科目二 3.3 生成式AI 導入評估規劃（含勘誤③） | 指引 科二 p.3-31～3-51（整理自 W4） | 10 |
| `w5-test.html` | W5 整合測驗（七大主題混合，模擬不分章節出題） | 科一 3.1～3.4 ＋ 科二 3.1～3.3 | 20 |

共 54 題，多為 W1–W4 官方原題／自編題重考，並把 114.04 勘誤表相關更正（科一 p.3-25／3-26／3-27／3-31／3-32、
科二 p.3-32）全部標示在對應日的整理筆記。科目二 3.2 因 STEP 1 未排完整週次，Day 4 整理時份量偏緊，
`w5-index.html` 已標註 STEP 2 後續互審優先看這一塊。W5 的 `day` 用 21～25（`w5test` 給總測驗）。
...
├── w5-test.html               W5 整合測驗（六大主題混合 20 題）
├── assets/
│   ├── style.css           共用樣式（深淺主題）
